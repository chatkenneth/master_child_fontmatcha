...
<?php switch_to_blog($main_blog); ?>
   ...
   <?php $term_args  = array('taxonomy' => 'all_websites_font_family','hide_empty' => false,'parent' => 0 , 'exclude' => array('1'),'fields' => 'names'); ?>
        ...
        <?php foreach($term_array as $all_items_ctr => $each_item): ?>
              <div class="col-12 col-lg-12">
                 <a href="javascript:void(0)" data-remodal-action="close"  class="d-block p-3 border">
                     ...
                     <span class="h3 text-center"><?php echo $each_item; ?></span>
                 </a>
